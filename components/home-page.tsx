    ...
    return (
        <>
                        ...
                        {focusAreas.map((area, index) => {
                            ...
                            return (
                                <Reveal key={area.title} delay={index * 0.06}>
                                    ...
                                    >
                                        <div
                                            className="relative h-full overflow-hidden rounded-4xl bg-night/75 p-5 sm:p-6 md:p-8">
                                            <div
                                                className="absolute -right-20 -top-20 size-56 rounded-full bg-cyan-glow/10 blur-3xl transition group-hover:bg-violet-glow/15"/>
                                            <div className="relative flex h-full flex-col">
                                                <div className="flex items-start justify-between gap-4">
                                                    <span
                                                        className="grid size-12 place-items-center rounded-2xl border border-cyan-glow/20 bg-cyan-glow/10 text-cyan-glow">
                                                        <Icon className="size-6" aria-hidden="true"/>
                                                    </span>
                                                    <span
                                                        className="rounded-full border border-white/10 bg-white/5 px-3 py-1 font-mono text-[11px] uppercase tracking-[0.2em] text-white/45">
                                                        0{index + 1}
                                                    </span>
                                                </div>
            ...
            <footer className="section-shell pb-28 md:pb-10">
                <div
                    className="flex flex-col gap-5 border-t border-white/10 py-8 text-sm text-soft md:flex-row items-center md:justify-between">
